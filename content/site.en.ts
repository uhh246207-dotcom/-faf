...
export const siteEn: SiteContent = {
  ...
  showcase: {
    eyebrow: 'EXPLORE',
    heading: 'Pick on the left, preview on the right',
    sub: 'Seven games and six design services, browseable from one panel. Use keyboard ← → to step through.',
    gamesLabel: 'Games',
    designLabel: 'Design',
    autoplayPlay: 'Resume autoplay',
  ...
  store: {
    ...
    trustGameChannel: 'Authorised channel',
    trustGameDelivery: 'Delivered in minutes',
    trustGameSuccess: '99% success rate',
    trustDesignSource: 'Source files included',
    trustDesignDelivery: 'On-time delivery',
    trustDesignRevisions: '2 free revisions',
  },
};
