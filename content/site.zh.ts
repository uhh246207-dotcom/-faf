...
export const siteZh: SiteContent = {
  ...
  store: {
    ...
    highlightsLabel: '亮点',
    aboutHeading: '产品介绍',
    relatedHeading: '你可能也会喜欢',
    moreFromBrand: '更多来自 {brand}',
    trustGameChannel: '官方授权渠道',
    trustGameDelivery: '分钟级到账',
    trustGameSuccess: '99% 充值成功率',
    trustDesignSource: '提供源文件',
    trustDesignDelivery: '准时交付',
    trustDesignRevisions: '免费 2 轮修改',
  },
};
