...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mt-2">Them Layer: {{ $template->name }}</h1>
</div>

<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl" x-data="{ type: '{{ old('type', 'text') }}' }">
    <form method="POST" action="{{ route('admin.layers.store', $template) }}" class="space-y-8">
        @csrf
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="layer_name" id="layer_name" value="{{ old('layer_name') }}" required
                           ...
                           placeholder="VD: EDIT_TITLE_TEXT">
                    @error('layer_name')
                ...
                <div class="flex items-center space-x-6 pt-6">
                    <label class="flex items-center">
                        ...
                        <input type="checkbox" name="editable" value="1" {{ old('editable', '1') == '1' ? 'checked' : '' }}
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div x-show="type === 'image'">
                    ...
                    <input type="text" name="accepted_file_types" id="accepted_file_types" value="{{ old('accepted_file_types', 'png,jpg,jpeg,webp') }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="preview_x" id="preview_x" value="{{ old('preview_x') }}" step="0.1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="preview_y" class="block text-sm font-medium text-gray-700 mb-1">Y (%)</label>
                    <input type="number" name="preview_y" id="preview_y" value="{{ old('preview_y') }}" step="0.1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="preview_width" class="block text-sm font-medium text-gray-700 mb-1">Width (%)</label>
                    <input type="number" name="preview_width" id="preview_width" value="{{ old('preview_width') }}" step="0.1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="preview_height" class="block text-sm font-medium text-gray-700 mb-1">Height (%)</label>
                    <input type="number" name="preview_height" id="preview_height" value="{{ old('preview_height') }}" step="0.1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="z_index" class="block text-sm font-medium text-gray-700 mb-1">Z-Index</label>
                    <input type="number" name="z_index" id="z_index" value="{{ old('z_index', 1) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>

        <!-- Section 4: Text Styling (only for text type) -->
        <div x-show="type === 'text'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="font_size" id="font_size" value="{{ old('font_size') }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="font_color" class="block text-sm font-medium text-gray-700 mb-1">Font Color</label>
                    <input type="color" name="font_color" id="font_color" value="{{ old('font_color', '#000000') }}"
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="stroke_width" id="stroke_width" value="{{ old('stroke_width') }}" step="0.1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="glow_color" class="block text-sm font-medium text-gray-700 mb-1">Glow Color</label>
                    <input type="color" name="glow_color" id="glow_color" value="{{ old('glow_color', '#ffffff') }}"
                           class="w-full h-10 px-1 py-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="brightness" class="block text-sm font-medium text-gray-700 mb-1">Brightness</label>
                    <input type="number" name="brightness" id="brightness" value="{{ old('brightness') }}" step="1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="contrast" class="block text-sm font-medium text-gray-700 mb-1">Contrast</label>
                    <input type="number" name="contrast" id="contrast" value="{{ old('contrast') }}" step="1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="saturation" class="block text-sm font-medium text-gray-700 mb-1">Saturation</label>
                    <input type="number" name="saturation" id="saturation" value="{{ old('saturation') }}" step="1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
        </div>
