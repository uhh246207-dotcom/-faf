...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-500">Ma Code</p>
                <p class="text-2xl font-bold text-gray-900">{{ $codeCount }}</p>
                <p class="text-xs text-gray-500">{{ $activeCodeCount }} dang hoat dong</p>
            </div>
        </div>
    </div>
</div>
